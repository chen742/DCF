...
class DACS(UDADecorator):
    ...
    def get_pseudo_label_and_weight(self, logits):
        ...
        # Tensor.ge computes input > other element wise
    ...
    def forward_train(self,
        ...
        clean_losses = self.get_model().forward_train(
            stage, img, img_metas, gt_semantic_seg, depth, target_depth, return_feat=True)
        ...
        if not self.source_only:
            ...
            mix_masks = get_class_masks(gt_semantic_seg, target_depth, pseudo_label, self.local_iter)
        ...
        if self.enable_masking and self.mask_mode.startswith('separate'):
            masked_loss = self.mic(stage, self.get_model(), img, img_metas,
